...
function open(){
    ...
    console.log(elem.attr('title').length);
    // We add a title if we find one on the link
    if (elem != null && elem.attr('title')) {
        //console.log(elem.attr('title').length);
        if (elem.attr('title').length > 110 && elem.find('img').length <=900) {
            //$('#zoombox .zoombox_title').css({"top":"-50px"});
            //console.log(elem.attr('title').length);
            //console.log("111");
        }
    ...
    if(elem != null && elem.find('img').length != 0 && isOpen == false){
        ...
        //if (elem.attr('title').length > 110) {
        //    console.log("114")
        //    $('#zoombox .zoombox_container').css({ 'marginTop': "-50px " });
        //}
